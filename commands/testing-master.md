---
description: Apply master TDD + robustness testing standards — Red/Green/Refactor cycle, AAA structure, mocking rules, and refactoring safety protocol. Use when writing or reviewing tests.
---
