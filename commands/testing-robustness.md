---
description: Apply test robustness standards — unit/integration test rules, boundary analysis, anti-patterns like snapshot abuse and overspecified mocks. Use when auditing or writing tests.
---

# Test Robustness Standards
...
3. **Setup/Teardown:** Each test must be atomic. Use `beforeEach` to reset state. Never rely on state left by a previous test.
