---
description: Apply Python coding standards — PEP 8, mandatory type hinting, Pydantic, pathlib, and security best practices. Use when writing or reviewing .py files.
---
