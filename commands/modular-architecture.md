---
description: Apply modular architecture standards — separation of concerns across Reasoning, Memory, and Tools layers. Use when designing or reviewing system architecture.
---
...
- **Pattern:** **Adapter Pattern**.
  ...
  - *Why?* This allows switching from SendGrid to SES by changing one config line, not the agent's logic.
