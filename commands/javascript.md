---
description: Apply JavaScript (Node.js/general) coding standards — ES6+ syntax, async/await patterns, module conventions, and security basics. Use when writing or reviewing .js or .mjs files.
---
