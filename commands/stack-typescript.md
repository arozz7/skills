---
description: Apply TypeScript & React coding standards — strict typing, no `any`, Zod validation, state management patterns, and size limits. Use when working in .ts or .tsx files.
---
