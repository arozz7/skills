---
description: Apply global security standards — least privilege, zero trust, input validation, secrets management, and dependency hygiene. Use when reviewing any code for security concerns.
---
